...
import { serialisationType } from "../helpers/typeHandler.js";
import { RestConnection, RestDevice } from "./REST.js";
import axios from "axios";
export class MTConnectConnection extends (RestConnection) {
    #connDetails;
    #cancelToken;
    #source;
    ...
    async startSubscription(metrics, payloadFormat, delimiter, interval, deviceId, subscriptionStartCallback) {
     ...
     */
    async sample(metrics, interval) {
        let res = await this.get(`/sample?interval=0&heartbeat=1000`, {
            responseType: "stream",
...
;
export class MTConnectDevice extends (RestDevice) {
    #devConn;
